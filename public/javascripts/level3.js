...
/*async function nextCostumer(){
    total = null;
    console.log(total);
    totalInput = null;
    numberOfWrongInputPrices = null;
    console.log(numberOfWrongInputPrices);



    $('#tableinput').empty()
    $('#costumerWishModal2').modal('hide');
}
...
function submitTip(){
    ...
    if( tipInputFormattet.toString() === totalWithTip.toString()){
        ...
        }else {coffeesForLevel3.splice(0,randomCoffeeNumberOf5);
        ...
        document.getElementById('AfterSubmitCardBody').innerHTML= "Thank you very much :) ";
            ...
            document.getElementById('tileHeaderAfterSubmit').innerHTML = "Yeahy you calculated correctly!!";
            document.getElementById('AfterSubmitCardBody').innerHTML= "Thank you very much for you service see you are prepared for the real world good luck!:) ";
        }
        document.getElementById('submitPriceInput').value = "";
...
async function loadModal() {
    ...
    costumerNumber = numberOfPayedCoffeeByOneCostumer;
